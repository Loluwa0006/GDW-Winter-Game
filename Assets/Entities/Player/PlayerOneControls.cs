...
//     version 1.11.2
//     from Assets/Entities/Player/PlayerOneControls.inputactions
//
...
public partial class @PlayerOneControls: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": ""D-Pad"",
                    ""id"": ""7b1fb1c8-a193-47cc-ac1b-8f4dfb3d86e4"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""9035bd22-1c40-4720-be45-e64166f6b392"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""0f0e736f-fece-46d2-adee-d88acf4406c0"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""8ba99dad-6f9a-4ef6-8fa7-da5d699dbd07"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""fd301bef-6e2c-4020-b094-e866e23cfac4"",
                ...
                {
                    ""name"": """",
                    ""id"": ""6d88dce3-71d0-45a4-993a-e56db09f717f"",
                    ""path"": ""<Keyboard>/h"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""e568c1bd-9161-4f3f-8908-28290052a7e7"",
                    ""path"": ""<Keyboard>/g"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ~@PlayerOneControls()
    {
        UnityEngine.Debug.Assert(!m_BattleControls.enabled, "This will cause a leak and performance issues, PlayerOneControls.BattleControls.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, PlayerOneControls.UI.Disable() has not been called.");
    }
    ...
    public struct BattleControlsActions
    {
        ...
        public BattleControlsActions(@PlayerOneControls wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @PlayerOneControls m_Wrapper;
        public UIActions(@PlayerOneControls wrapper) { m_Wrapper = wrapper; }
